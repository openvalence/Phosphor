 ...
 *
 * Run:  node test/valence-wire.test.mjs   (exits 1 on any failure)
 *
...
} from '../../Valence/clients/js/catalog.js';
import { sha256, catalogEtag, toHex, bytesEqual } from '../../Valence/clients/js/sha256.js';
